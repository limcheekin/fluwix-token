/**
 * @notice Unit test for The FluwixToken
 * @author brian wu
 */
var FluwixToken = artifacts.require("./FluwixToken.sol");
const BN = web3.utils.BN;

contract('FluwixToken', ([owner, operator, other, ...accounts]) => {
  ...
  before(async () => {
    token = await FluwixToken.new(name, symbol, initialAccount, initialBalance)
